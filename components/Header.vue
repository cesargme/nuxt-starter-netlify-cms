      ...
      <div class="
        ...
        <div>
          <nuxt-link to="/" class="flex">
            <img class="h-12" src="/img/logo.svg" alt="Workflow" />
          </nuxt-link>
        </div>
        ...
        <div class="
            hidden
            md:flex-1 md:flex md:items-center md:justify-between md:space-x-12
          ">
          <nav class="flex space-x-10">
            <nuxt-link to="/products" class="
                text-base
                font-medium
                leading-6
                text-gray-500
          ...
          <div class="flex items-center space-x-8">
            <a href="https://github.com/lukeocodes/nuxt-starter-netlify-cms" target="_blank">
              <img class="h-6 ml-2"
            ...
            <div class="px-5 py-6 space-y-6">
              ...
              <div class="space-y-6">
                <p class="
                  ...
                  ">
                  <a href="https://github.com/lukeocodes/nuxt-starter-netlify-cms" target="_blank" class="
                      flex
                      justify-center
                      transition
                      duration-150
